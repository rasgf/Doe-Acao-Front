        ...
        <div className="container flex flex-col mx-auto items-center mb-8">
            ...
            <form className="flex flex-col w-full px-8 gap-4" onSubmit={gerarNovaPostagem}>
                ...
                <button
                    ...
                    className='flex justify-center items-center rounded text-white bg-rose-500   border-rose-500 mr-2  font-bold border-solid border-2 py-2 px-4 transition-all hover:shadow-lg hover:shadow-rose-500/40 active:opacity-[0.85]'
                >
                    {isLoading ?
                        <RotatingLines
                            strokeColor="white"
